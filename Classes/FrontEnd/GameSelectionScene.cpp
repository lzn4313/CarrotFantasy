...
bool BigLevelLayer::init()
{
    ...
    page_0->setTag(0);
    page_0->setScale(1.4);
    page_0->setPosition(Vec2(visibleSize.width * 0.47,
    ...
    page_1->setTag(1);
    page_1->setScale(1.4);
    page_1->setPosition(Vec2(visibleSize.width * 0.49,
        visibleSize.height * 0.05));
    ...
    page_2->setTag(2);
    page_2->setScale(1.4);
    page_2->setPosition(Vec2(visibleSize.width * 0.51,
        visibleSize.height * 0.05));
    ...
    page_3->setTag(3);
    page_3->setScale(1.4);
    page_3->setPosition(Vec2(visibleSize.width * 0.53,
        visibleSize.height * 0.05));
    ...
    left_btn->setPosition(Vec2(visibleSize.width *0.1,
    ...
    right_btn->setPosition(Vec2(visibleSize.width *0.9,
        visibleSize.height / 2));
...
void BigLevelLayer::create_slide_layer()
{
    ...
    evaluate->setPosition(Vec2(visibleSize.width * (-0.5),
        visibleSize.height / 2));
    ...
    skyline->setPosition(Vec2(visibleSize.width / 2,
    ...
    level_1_statistics_image->setPosition(Vec2(visibleSize.width * 0.66,
        visibleSize.height * 0.11));
    ...
    level_1_statistics_txt->setPosition(Vec2(visibleSize.width * 0.66,
        visibleSize.height * 0.12));
    ...
    jungle->setPosition(Vec2(visibleSize.width *1.5,
        visibleSize.height * 0.45));
    ...
    if (UserDefault::getInstance()->getIntegerForKey("level_2") == 0) {
        ...
        level_2_lock->setPosition(Vec2(visibleSize.width * 1.78,
    ...
    desert->setPosition(Vec2(visibleSize.width * 2.5,
        visibleSize.height * 0.45));
    ...
    if (UserDefault::getInstance()->getIntegerForKey("level_3") == 0) {
        ...
        level_3_lock->setPosition(Vec2(visibleSize.width * 2.78,
            visibleSize.height * 0.2));
...
void BigLevelLayer::goto_evaluate(Ref* psender)
{
    ...
    evaluate_image->setPosition(Vec2(visibleSize.width / 2,
        visibleSize.height / 2));
